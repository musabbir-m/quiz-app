    ...
    return (
        <div className='grid grid-cols-5 gap-10 py-32 px-12 bg-slate-50'>
            <div className=' col-span-3 w-5/6 mx-auto'>
                ...
                <p className=' font-thin'>The <span className='font-bold'>QuizAPI</span> is a SaaS which lets you test your knowledge on a wide variety of
                    technical topics. You can create your own Quiz or get random set of
                    questions for a speicifc topic including Linux, DevOps, BASH, PHP and lots more. We offer an easy to use API which allows you
                    to embed the quiz on your own website.
                ...
                <div className='mt-8'>
                    <Row className='my-10'>
                        ...
                        <Col span={12}>
                            ...
                            <p className='text-md font-thin'>Create your own Quiz Wrapper</p>
                        </Col>
                    </Row>
                    <Row>
                        <Col span={12}>
            ...
            <div className='col-span-2'>
                <img src="https://quizapi.io/storage/api.svg" alt="" />
            </div>
        </div>
    );
};
